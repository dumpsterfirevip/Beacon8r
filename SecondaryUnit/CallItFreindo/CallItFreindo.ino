...
void sendBeacon(char* ssid) {
    ...
    uint8_t packet[128] = { 0x80, 0x00, //Frame Control 
                ...
                /*32*/  0xFF, 0x00, //Beacon interval maybe.  Not all hardware respects it? probably my lack of understanding -ja
...
void RickRoll() {
  sendBeacon("Virus Detected");
  sendBeacon("Call it Friendo");
  sendBeacon("Bulbasaur");
  sendBeacon("Mew-Too");
  sendBeacon("HP-Print-A4-LaserJet 1302"); 
  sendBeacon("MR MESEEKS");
  sendBeacon("Morty Crew");
  sendBeacon("Spice Must Flow");
  sendBeacon("Join Outer Worlds");
  sendBeacon("FREE USB DRIVE");
  sendBeacon("👾👾👾👾👾👾👾👾👾");
  sendBeacon("🤖🤖🤖🤖🤖🤖🤖🤖🤖");
  sendBeacon("👻👻👻👻👻👻👻👻👻");
  sendBeacon("🎃🎃🎃🎃🎃🎃🎃🎃🎃");
