 ...
 * Based on Markszabo https://github.com/markszabo/FakeBeaconESP8266 and 
 *  WiFiBeaconJam by kripthor (https://github.com/kripthor/WiFiBeaconJam) 
 * 
 * More info: http://nomartini-noparty.blogspot.com/2016/07/esp8266-and-beacon-frames.html
 
 This rick roll won't show up in wireshark because the timestamp is not being set. See other examples in project where it is if you want to copy.
 */
